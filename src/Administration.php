...
final class Administration extends UserManager {
	 ...
	 */
	public function __construct($databaseConnection, $dbTablePrefix = null, $dbSchema = null, &$seesion) {
		parent::__construct($databaseConnection, $dbTablePrefix, $dbSchema, $seesion);
	}

...
abstract class UserManager {
	...
	protected function onLoginSuccessful($userId, $email, $username, $status, $roles, $forceLogout, $remembered) {
		...
		$arr[self::SESSION_FIELD_USER_ID] = (int) $userId;
		$arr[self::SESSION_FIELD_EMAIL] = $email;
		$arr[self::SESSION_FIELD_USERNAME] = $username;
		$arr[self::SESSION_FIELD_STATUS] = (int) $status;
		$arr[self::SESSION_FIELD_ROLES] = (int) $roles;
